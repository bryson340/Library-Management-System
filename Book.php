...
class Book {
    ...
    // 2. Add a new book
    public function create($title, $author, $genre, $image) {
        $query = "INSERT INTO " . $this->table_name . " (title, author, genre, cover_image) VALUES (:title, :author, :genre, :image)";
        $stmt = $this->conn->prepare($query);
    ...
    public function borrow($book_id, $user_id) {
        $query1 = "UPDATE " . $this->table_name . " SET is_available = 0 WHERE book_id = :book_id";
        $stmt1 = $this->conn->prepare($query1);
        $stmt1->bindParam(":book_id", $book_id);
        
        $query2 = "INSERT INTO issued_books (user_id, book_id) VALUES (:user_id, :book_id)";
    ...
    public function returnBook($issue_id, $book_id) {
        ...
        $query_book = "UPDATE books SET is_available = 1 WHERE book_id = :book_id";
    ...
    public function update($id, $title, $author, $genre, $cover_image) {
        $query = "UPDATE " . $this->table_name . " 
                  SET title = :title, author = :author, genre = :genre, cover_image = :cover_image 
                  WHERE book_id = :id";
